...
Remaining after tranche 10a: 6 ACTIVE useState (all domain 11: e2eReady, e2eKeyVersion, callState, groupCallState, activeGroupCallId + 1). NEXT: tranche 11 (E2EE/calls, the finale) — then companion 10b (services/messages.ts I/O extraction).
