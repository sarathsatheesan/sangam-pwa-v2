...
// Expanded ethnicity options with sub-groups for Login 1.0
// Each nationality has a broad option + specific sub-groups
export const ETHNICITY_OPTIONS = [
  // Indian — broad + sub-groups
  'Indian',
  'Indian - Tamil',
  'Indian - Telugu',
  'Indian - Punjabi',
  ...
  'Pakistani - Kashmiri',
  'Pakistani - Other',
  // Bangladeshi — broad + sub-groups
  'Bangladeshi',
  'Bangladeshi - Bengali',
  'Bangladeshi - Chakma',
  'Bangladeshi - Other',
  // Sri Lankan — broad + sub-groups
  'Sri Lankan',
  'Sri Lankan - Sinhala',
  'Sri Lankan - Tamil',
  'Sri Lankan - Moor',
  'Sri Lankan - Other',
  // Afghan — broad + sub-groups
  'Afghan',
  'Afghan - Pashtun',
  'Afghan - Tajik',
  'Afghan - Hazara',
  'Afghan - Other',
  // Other South Asian (no sub-groups needed)
  'Nepali',
  'Bhutanese',
  'Maldivian',
  // Broader categories
...
export const ETHNICITY_KEYWORDS: Record<string, string[]> = {
  ...
  telugu: ['Indian - Telugu'],
  punjabi: ['Indian - Punjabi', 'Pakistani - Punjabi'],
  gujarati: ['Indian - Gujarati'],
  bengali: ['Indian - Bengali', 'Bangladeshi - Bengali'],
  marathi: ['Indian - Marathi'],
  kannada: ['Indian - Kannada'],
  malayalam: ['Indian - Malayalam'],
  malayali: ['Indian - Malayalam'],
  hindi: ['Indian - Hindi Belt'],
  kashmiri: ['Indian - Kashmiri', 'Pakistani - Kashmiri'],
  assamese: ['Indian - Assamese'],
  odia: ['Indian - Odia'],
  oriya: ['Indian - Odia'],
  konkani: ['Indian - Konkani'],
  rajasthani: ['Indian - Rajasthani'],
  sindhi: ['Pakistani - Sindhi'],
  pashtun: ['Pakistani - Pashtun', 'Afghan - Pashtun'],
  pathan: ['Pakistani - Pashtun', 'Afghan - Pashtun'],
  baloch: ['Pakistani - Baloch'],
  muhajir: ['Pakistani - Muhajir'],
  sinhala: ['Sri Lankan - Sinhala'],
  sinhalese: ['Sri Lankan - Sinhala'],
  moor: ['Sri Lankan - Moor'],
  chakma: ['Bangladeshi - Chakma'],
  hazara: ['Afghan - Hazara'],
  tajik: ['Afghan - Tajik'],
  nepali: ['Nepali'],
  bhutanese: ['Bhutanese'],
  maldivian: ['Maldivian'],
