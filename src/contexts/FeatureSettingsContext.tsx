...
export const DEFAULT_FEATURES: Record<string, boolean> = {
  ...
  messages_fileSharing: true,
  messages_linkPreviews: true,
  messages_gifStickers: true,
  messages_disappearingMessages: true,
  messages_groupCalls: true,
  messages_oneToOneCalls: true,
  messages_screenSharing: true,
  messages_pushNotifications: true,
  messages_onlineLastSeen: true,
  messages_pinnedMessages: true,
  messages_starredMessages: true,
  messages_forwardMessages: true,
  messages_deleteMessages: true,
...
export const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'feed_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
    ],
  },
  {
    id: 'discover',
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'business_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'housing_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'events_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'messages_voiceToText', name: 'Voice-to-Text', description: 'Allow transcribing voice messages to text via Speech-to-Text API' },
      ...
      { key: 'messages_fileSharing', name: 'File Sharing', description: 'Allow sending documents and files (PDF, DOCX, etc.) in chat' },
      { key: 'messages_linkPreviews', name: 'Link Previews', description: 'Show rich previews for shared URLs with title, image, and description' },
      { key: 'messages_gifStickers', name: 'GIF & Stickers', description: 'Allow sending GIFs and stickers via Giphy integration' },
      { key: 'messages_disappearingMessages', name: 'Disappearing Messages', description: 'Allow setting auto-delete timers on messages' },
      { key: 'messages_groupCalls', name: 'Group Calls', description: 'Allow multi-party video/audio calls in group conversations (up to 8)' },
      { key: 'messages_oneToOneCalls', name: '1:1 Calls', description: 'Allow direct audio and video calls between two users' },
      { key: 'messages_screenSharing', name: 'Screen Sharing', description: 'Allow screen sharing during video calls' },
      { key: 'messages_pushNotifications', name: 'Push Notifications', description: 'Send background push notifications for new messages via FCM' },
      { key: 'messages_onlineLastSeen', name: 'Online / Last Seen', description: 'Show user online status and last seen timestamps' },
      { key: 'messages_pinnedMessages', name: 'Pinned Messages', description: 'Allow pinning important messages in conversations' },
      { key: 'messages_starredMessages', name: 'Starred Messages', description: 'Allow starring messages for quick access later' },
      { key: 'messages_forwardMessages', name: 'Forward Messages', description: 'Allow forwarding messages to other conversations' },
      { key: 'messages_deleteMessages', name: 'Delete Messages', description: 'Allow users to delete their sent messages' },
    ],
  },
  {
    id: 'travel',
    ...
    features: [
      ...
      { key: 'travel_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
    ],
  },
  {
    id: 'forum',
    ...
    features: [
      ...
      { key: 'forum_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage filter chips' },
    ],
  },
  {
    id: 'auth',
