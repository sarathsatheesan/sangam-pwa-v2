...
export const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'feed_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
    ],
  },
  {
    id: 'discover',
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'business_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'housing_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'events_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'travel_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
    ],
  },
  {
    id: 'forum',
    ...
    features: [
      ...
      { key: 'forum_heritageFilter', name: 'Heritage Filter', description: 'Enable heritage/ethnicity filter chips' },
    ],
  },
  {
    id: 'auth',
