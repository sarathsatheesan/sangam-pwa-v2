  ...
  return (
    <div className="min-h-screen bg-aurora-surface-variant flex flex-col">
      ...
      <div className="relative overflow-hidden rounded-b-3xl">
        <img src="/ethnicity-banner.jpg" alt="ethniCity — Our culture, connected." className="w-full h-40 sm:h-56 object-cover object-center" />
      </div>
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row md:gap-10 md:items-stretch">
          {/* Left column — placeholder image (desktop only) */}
          <div className="hidden md:flex md:w-1/2 flex-col">
            <div className="w-full flex-1 bg-gradient-to-br from-blue-50 via-white to-orange-50 rounded-2xl flex flex-col items-center justify-center border border-blue-100 p-8">
              <img src="/earth.svg" alt="Earth" className="w-64 h-64 mb-6 drop-shadow-aurora-3" />
              <h3 className="text-xl font-bold text-aurora-text mb-2">Stronger Together</h3>
              <p className="text-aurora-text-muted text-sm text-center px-4">
                Connect, grow, and belong in a community that puts people first.
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Mobile-only Earth image — between form and sign-up link */}
            {(step === 0 || step === 2) && (
              <div className="md:hidden mt-8">
                <div className="w-full bg-gradient-to-br from-blue-50 via-white to-orange-50 rounded-2xl flex flex-col items-center justify-center border border-blue-100 py-6 px-4">
                  <img src="/earth.svg" alt="Earth" className="w-36 h-36 mb-3 drop-shadow-aurora-2" />
                  <h3 className="text-lg font-bold text-aurora-text mb-1">Stronger Together</h3>
                  <p className="text-aurora-text-muted text-xs text-center px-4">
                    Connect, grow, and belong in a community that puts people first.
                  </p>
                </div>
              </div>
